...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
        ...
        if self.use_slot_bottleneck:
            self.slot_adapter = SmoothSASlotAdapter(
                ...
                decode=ARRandTransformerDecoder(
                    ...
                    num_tokens=self.vision_backbone.get_num_patches(),
    ...
    def _process_vision_features(
        ...
        projected_slots = self.slot_projector(slotz).reshape(batch_size, num_images * self.num_slots, -1)
    ...
    def forward(
        ...
        # === Handle Multimodal Forward ===
            ...
            # Get visual features / SmoothSA-style slot tokens
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _regression_or_discrete_prediction(
        ...
        num_visual_tokens = projected_patch_embeddings.shape[1]
